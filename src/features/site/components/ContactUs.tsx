...
const ContactUs: React.FC<ContactUsProps> = ({
  ...
  const title = propTitle ?? contactData?.title ?? "تواصل معنا";
  const description =
    propDescription ??
  ...
  const contactInfo =
    ...
    (contactData?.contact_info
      ? {
          email: contactData.contact_info.email || undefined,
          phone: contactData.contact_info.phone || undefined,
          address: contactData.contact_info.address || undefined,
        }
      : undefined);
  ...
  const socialLinks =
    ...
    (contactData?.social_media
      ? {
          instagram: contactData.social_media.instagram || undefined,
          twitter: contactData.social_media.twitter || undefined,
          facebook: contactData.social_media.facebook || undefined,
        }
      : undefined);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-3 w-full">
              {!hasContactInfo ? (
                <div className="p-4 rounded-xl bg-purple-50/60 border border-purple-100/70 text-mad-text-secondary text-sm">
