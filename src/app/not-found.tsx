...
export default function NotFound() {
  return (
    <div dir="rtl" className="min-h-screen flex flex-col bg-mad-white-50 font-sans">
      ...
      <main className="flex-1 flex items-center justify-center relative overflow-hidden py-12 sm:py-20 px-4 sm:px-6 lg:px-8">
        {/* Ambient Background Glows */}
        <div className="absolute top-1/2 right-1/2 transform translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-mad-purple-200/30 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="container relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <div className="relative w-64 h-52 sm:w-80 sm:h-64 md:w-[440px] md:h-[320px] mx-auto select-none animate-bounce duration-1000">
            <Image
              src="/assets/404.png"
