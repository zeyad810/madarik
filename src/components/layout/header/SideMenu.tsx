      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            onClick={onClose}
            aria-hidden="true"
            className="fixed inset-0 z-149 bg-black/60 backdrop-blur-xs"
          />
          ...
          <motion.aside
            ...
            className="fixed top-0 bottom-0 right-0 z-150 flex w-80 sm:w-90 rounded-tl-4xl rounded-bl-4xl flex-col bg-white shadow-[0_0_60px_rgba(0,0,0,0.25)] overflow-hidden will-change-transform"
          >
                      ...
                      >
                        ...
                        {isFreeCustomer ? (
                          <button
                            ...
                            className="w-full py-2 px-3 rounded-xl border border-dashed border-gray-200 bg-gray-50 text-gray-400 font-bold text-xs flex items-center justify-center gap-1.5 transition-all mt-1 cursor-not-allowed opacity-70"
                          >
